> [!WARNING]  
> These bindings are not actively maintained, you should prefer using the ones from
> the [flash-attn3-jax](https://github.com/kyutai-labs/flash-attn3-jax) repo instead.
